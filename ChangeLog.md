## 2021-12-17 3.6.0 (iRon)
  - Updated
    - Implemented #29: key expressions (requires explicit -Using parameter for compare expressions)
...
## 2021-07-06 3.5.3 (iRon)
  - Fixes
    - Fixed issue #27: MissingLeftProperty: Join-Object : The property 'xxx' cannot be found on the left object.
...
## 2021-04-08 3.4.6 (iRon)
  - Fixes
    - Fixed issue #19: Deal with empty (and $Null) inputs
