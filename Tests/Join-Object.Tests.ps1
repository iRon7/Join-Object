...
Describe 'Join-Object' {
    ...
    BeforeAll {
        ...
        Set-StrictMode -Version 2#Requires -Modules @{ModuleName="Pester"; ModuleVersion="5.0.0"}
...
'@
    ...
    Context 'Self join' {
        ...
        It 'LeftJoin $Employee -On ReportsTo -Equals Id -Discern *1,*2' {
            ...
            Id Name1   Country1 Department1 Age1 Name2  Country2 Department2 Age2   ReportsTo
            -- -----   -------- ----------- ---- -----  -------- ----------- ----   ---------
             5 Aerts   Belgium  Sales         40 Evans  England  Marketing       35
             4 Bauer   Germany  Engineering   31 Duval  France   Engineering     21         5
             1 Cook    England  Sales         69 Aerts  Belgium  Sales           40         5
             5 Duval   France   Engineering   21 Evans  England  Marketing       35
               Evans   England  Marketing     35  $Null    $Null       $Null  $Null     $Null
             4 Fischer Germany  Engineering   29 Duval  France   Engineering     21         5'
        ...
        It 'InnerJoin $Employee -On ReportsTo, Department -Equals Id -Discern *1,*2' {
            ...
            $Expected = ConvertFrom-SourceTable '
                Id Name1   Country1 Department  Age1 Name2 Country2 Age2 ReportsTo
                -- -----   -------- ----------  ---- ----- -------- ---- ---------
                 4 Bauer   Germany  Engineering   31 Duval France     21         5
                 1 Cook    England  Sales         69 Aerts Belgium    40         5
                 4 Fischer Germany  Engineering   29 Duval France     21         5'
